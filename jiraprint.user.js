...
addStyle('.aui-header,.command-bar,.navigator-issue-only #stalker .page-navigation, header .breadcrumbs li, #heading-avatar, #footer, #activitymodule, #greenhopper-agile-issue-web-panel, #datesmodule, #addcomment, #details-module_heading, #peoplemodule_heading, #votes-val, #watchers-val, .twixi, #attachmentmodule, #linkingmodule, #timetrackingmodule, #view-subtasks, #peoplemodule, #drag-and-drop-attachment-panel, #hipchat-viewissue-panel, #rowForcustomfield_11250, #rowForcustomfield_11252, #rowForcustomfield_11255, #status-val, .status-view, #priority-val, #resolution-val, #wrap-labels {display:none !important;}');
...
addStyle('h1 {margin:0 0 0 0px!important;padding:0!important;background:none!important;font-size:20px;}');
// Content styles
...
addStyle('.twixi-wrap {padding:0!important;}');
addStyle('ul.breadcrumbs > li, .content-body  {padding:0!important;}');
addStyle('p {font-size: 12px;}');
addStyle('.aui-nav-breadcrumbs {font-size:4em}');
addStyle('.issue-header-content .aui-nav-breadcrumbs > li + li::before {display: none!important');
addStyle('.aui-nav-breadcrumbs > li {padding:0!important}');
addStyle('.aui-nav-breadcrumbs > li:first-child {display:none!important}');
addStyle('#issuedetails > .item > .wrap > .name {display:none!important}');
addStyle('#rowForcustomfield_10953 {line-height:normal!important; font-size:15px!important}');
